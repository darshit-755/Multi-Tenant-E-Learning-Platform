...
const AttendanceForm = ({ classId, onSubmit, students = [] }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await markAttendance(classId, attendanceData);
  ...
  return (
    <div className="space-y-5 rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-xl font-semibold text-slate-900">Take Attendance</h2>
